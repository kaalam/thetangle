...
class EchoTarget:
	...
	def __init__(self, out_path = etl_dest):
		...
		self.in_short.write_line('20260101')
		self.texts.write_line('enwiki-20260101-pages-articles-multistream.xml downloaded from https://dumps.wikimedia.org/enwiki/')
...
class Wikipedia:
	...
	def __init__(self,
				 source_fn = etl_source + '/en_wiki_20260101/enwiki-20260101-pages-articles-multistream.xml',
				 out_path  = etl_dest):
